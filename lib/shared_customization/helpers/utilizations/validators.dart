...
class Validators {
  ...
  static String? validateEmail(String? value) {
    if (value.isEmptyOrNull) {
      return tr(LocaleKeys.CommonValidation_Required,
          args: [tr(LocaleKeys.CommonData_Email)]);
  ...
  static String? validatePassword(String? value,
    ...
    if (value == null || value.trim().isEmpty) {
      return tr(LocaleKeys.CommonValidation_Required, args: [
        isNew
    ...
    if (value.length < PASSWORD_MIN_LENGTH) {
      return tr(
        LocaleKeys.CommonValidation_MinLength,
        args: [
          isNew
              ? tr(LocaleKeys.ChangePassword_NewPassword)
              : tr(LocaleKeys.CommonData_Password),
    ...
    if (value.length > PASSWORD_MAX_LENGTH) {
      return tr(LocaleKeys.CommonValidation_MaxLength, args: [
        isNew
            ? tr(LocaleKeys.ChangePassword_NewPassword)
            : tr(LocaleKeys.CommonData_Password),
  ...
  static String? validateConfirmPassword(String? pwd, String? confirmPwd,
    ...
    if (confirmPwd.length < PASSWORD_MIN_LENGTH) {
      return tr(LocaleKeys.CommonValidation_MinLength, args: [
        isNewConfirmPwd
            ? tr(LocaleKeys.ChangePassword_NewConfirmPassword)
            : tr(LocaleKeys.Register_ConfirmPassword),
        PASSWORD_MIN_LENGTH.toString()
    ...
    return isEmptyOrNull
        ? errorCode ??
            (fieldName.isNotEmptyOrNull
                ? tr(LocaleKeys.CommonValidation_Required, args: [fieldName!])
